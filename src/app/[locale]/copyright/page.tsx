...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Roblox Animal Hospital Wiki',
    description: 'Copyright and intellectual property information for Roblox Animal Hospital Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Roblox Animal Hospital Wiki',
      description: 'Copyright and intellectual property information for Roblox Animal Hospital Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Roblox Animal Hospital Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Roblox Animal Hospital Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Roblox Animal Hospital Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Animal Hospital (Anomaly) Developers</strong> - Creators of the Animal Hospital (Anomaly) game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Animal Hospital (Anomaly)</strong> - Trademark of the game developers</li>
              <li><strong>Roblox Animal Hospital Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Roblox Animal Hospital Wiki.
            </p>
            ...
            <p>
              ...
              Roblox Animal Hospital Wiki<br />
              Email: <a href="mailto:dmca@robloxanimalhospital.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@robloxanimalhospital.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Roblox Animal Hospital Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Roblox Animal Hospital Wiki (robloxanimalhospital.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@robloxanimalhospital.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@robloxanimalhospital.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@robloxanimalhospital.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@robloxanimalhospital.online</a>
            </p>
            <p>
