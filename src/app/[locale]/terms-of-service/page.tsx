...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://robloxanimalhospital.online'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Roblox Animal Hospital Wiki",
    description: "Read the Terms of Service for Roblox Animal Hospital Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Roblox Animal Hospital Wiki",
      title: "Terms of Service - Roblox Animal Hospital Wiki",
      description: "Terms and conditions for using Roblox Animal Hospital Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          alt: "Roblox Animal Hospital Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Roblox Animal Hospital Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Roblox Animal Hospital Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Roblox Animal Hospital Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Roblox Animal Hospital Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Animal Hospital (Anomaly)". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Anomaly identification and class guides</li>
              <li>Patient and anomaly information</li>
              <li>Enemy and anomaly guides</li>
              <li>Achievement walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Roblox Animal Hospital Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Animal Hospital (Anomaly). We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Roblox Animal Hospital Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Animal Hospital (Anomaly). We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ROBLOX ANIMAL HOSPITAL WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Roblox Animal Hospital Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@robloxanimalhospital.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@robloxanimalhospital.online</a>
            </p>
            <p>
