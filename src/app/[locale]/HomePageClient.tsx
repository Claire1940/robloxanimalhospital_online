    ...
    "@graph": [
      ...
      },
      {
        ...
        sameAs: [
          ...
          "https://animal-hospital.fandom.com/wiki/Animal_Hospital_Wiki",
          "https://discord.com/invite/animal-hospital",
        ],
      },
      {
        "@type": "VideoGame",
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.com/invite/animal-hospital"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.youtube.com/@AnimalAnomaly"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.roblox.com/communities/animal-anomaly"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
